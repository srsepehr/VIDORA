  ...
  return (
    <main className={`vd-page ${isFa ? "is-fa" : ""}`}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .vd-shell{width:min(1420px,100%);height:min(860px,calc(100vh - 64px));min-height:690px;display:grid;grid-template-columns:310px minmax(0,1fr);grid-template-areas:"sidebar main";gap:14px;border-radius:36px;border:1px solid rgba(255,255,255,.48);background:rgba(238,239,236,.44);box-shadow:0 34px 105px rgba(36,37,34,.18),inset 0 1px 0 rgba(255,255,255,.58);backdrop-filter:blur(26px);-webkit-backdrop-filter:blur(26px);padding:14px;overflow:hidden}.is-fa .vd-shell{grid-template-columns:minmax(0,1fr) 310px;grid-template-areas:"main sidebar"}
        .vd-sidebar{grid-area:sidebar;border-radius:28px;background:rgba(243,244,241,.55);border:1px solid rgba(255,255,255,.5);box-shadow:inset 0 1px 0 rgba(255,255,255,.48);backdrop-filter:blur(22px);-webkit-backdrop-filter:blur(22px);padding:24px 20px;overflow:auto;display:flex;flex-direction:column}.vd-user{width:100%;border:0;background:transparent;display:flex;align-items:center;gap:14px;margin-bottom:24px;text-align:left;cursor:pointer;color:#111}.vd-sidebar-profile{margin-top:auto;margin-bottom:0;border-top:1px solid rgba(30,30,28,.1);padding:18px 13px 0}.vd-sidebar-profile>div:nth-child(2){min-width:0;flex:1}.vd-sidebar-profile svg{color:#696b67;flex:0 0 auto}.is-fa .vd-user{text-align:right}.vd-avatar{width:54px;height:54px;border-radius:999px;background:linear-gradient(145deg,#fafafa,#d9dad6);border:1px solid rgba(255,255,255,.7);box-shadow:0 10px 18px rgba(0,0,0,.12);display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:800;color:#202020;flex:0 0 auto}.vd-avatar.large{width:82px;height:82px;font-size:30px}.vd-user h2{margin:0;font-size:19px;line-height:1.1;font-weight:700;letter-spacing:0}.vd-user p{margin:5px 0 0;color:#6d6f6b;font-size:14px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.vd-technical-text{direction:ltr;text-align:left;unicode-bidi:plaintext}.vd-section{padding:14px 0}.vd-section+.vd-section{border-top:1px solid rgba(30,30,28,.1)}.vd-label{font-size:12px;color:#858782;margin:0 0 10px;text-transform:uppercase;letter-spacing:.08em;font-weight:700}
