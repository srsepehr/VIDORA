...
python3 -c "import worker.app.main; import worker.app.health; import worker.app.pipeline; import worker.app.translation_local; import worker.app.subtitles; import worker.app.subtitle_generation; import worker.app.insights; import worker.app.insight_generation; import worker.app.insight_provider; import worker.app.chat_index; import worker.app.chat_service; import worker.app.chat_provider; import worker.app.embedding_provider; import worker.app.notes; import worker.app.note_service; import worker.app.note_provider; print('imports ok')"
...
python3 -m unittest worker.tests.test_worker worker.tests.test_subtitles worker.tests.test_subtitle_generation worker.tests.test_insights worker.tests.test_insight_generation worker.tests.test_chat worker.tests.test_notes worker.tests.test_note_service
